                ...
                <div class="p-3 py-5">
                    ...
                    <div class="row mt-3">
                        <div class="col-md-12"><label class="labels">gender</label><input type="text"
                                class="form-control" value="<?php echo $row['gender']; ?>" readonly></div><br><br><br>
                        <div class="col-md-12"><label class="labels">Blood Group</label><input type="text"
                                class="form-control" value="<?php echo $row['blood_group']; ?>" readonly></div>
                        <br><br><br>
                        <div class="col-md-12"><label class="labels">Date Of Birth</label><input type="text"
                                class="form-control" value="<?php echo $row['dob']; ?>" readonly></div><br><br><br>
                        <div class="col-md-12"><label class="labels">Phone</label><input type="text"
                                class="form-control" value="<?php echo $row['phone']; ?>" readonly></div><br><br><br>
                        <div class="col-md-12"><label class="labels">Aadhar No.</label><input type="text"
                                class="form-control" value="<?php echo $row['aadhar']; ?>" readonly></div><br><br>
