                    ...
                    <div class="row justify-content-center">
                        <div class="col-md-8">
                            <button onclick="history.back()"
                                style="background-color:#2db2fa; padding:5px 15px 5px 15px;" class="btn btn-dark"><i
                                    class=" fa-solid fa-arrow-left"></i></button>
                            <div class="card">
                                <div class="card-header" style="background-color:#46a0f0fe; color:white;"><b>Add
                                        Patient</b>
                                </div>
                                <div class="card-body">
                                    <form method="POST" id="patient" action="add_patient.php"
                                        ...
                                        <div class="form-group row">
                                            <label for="blood_group"
                                                class="col-md-4 col-form-label text-md-right">Blood_group</label>
                                            <div class="col-md-6">
                                                <select id="blood_group" name="blood_group" class="form-control">
                                                    <option value="none" selected disabled hidden>Select Blood Group
                                                    </option>
...
<?php
// Inside form_patient.php

if (isset($_SESSION['barcode_image'])) {
    echo '<p>Barcode generated successfully! Downloading...</p>';

    // Create a temporary HTML element with the base64-encoded image data and trigger download
    echo '<a id="downloadLink" style="display: none;" href="data:image/png;base64,' . base64_encode($_SESSION['barcode_image']) . '" download>Download Barcode</a>';
    ...
    unset($_SESSION['barcode_image']); // Clear the session variable
}

// Your existing code for the patient form
?>