            ...
            <div class="row" style="display:inline;">
                <div class="col-lg-7 position-relative z-index-2">
                    ...
                    <div class="row justify-content-center">
                        <div class="col-md-8">
                            <div class="card">
                                <div class="card-header" style="background-color:#46a0f0fe; color:white;">Add license
                                </div>
                                <div class="card-body">
                                    <form method="POST" id="license" action="add_license.php"
                                        ...
                                        <div class="form-group row">
                                            <label for="license"
                                                class="col-md-4 col-form-label text-md-right">license</label>
                                            <div class="col-md-6">
