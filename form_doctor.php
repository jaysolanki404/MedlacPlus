                    ...
                    <div class="row justify-content-center">
                        <div class="col-md-8">
                            <button onclick="history.back()"
                                style="background-color:#216ABE ; padding:5px 15px 5px 15px;" class="btn btn-dark"><i
                                    class=" fa-solid fa-arrow-left"></i></button>
                            <div class="card">
                                <div class="card-header" style="background-color:#46a0f0fe; color:white;">Add Doctor
                                </div>
                                <div class="card-body">
                                        ...
                                        <div class="form-group row">
                                            ...
                                            <div class="col-md-6">
                                                <select id="gender" class="form-control" name="gender"
                                                    style="background-color:white ;">
                                                    <option value="" disabled selected>Select Gender<F /option>
