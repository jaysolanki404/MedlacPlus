                ...
                <div class="col-lg-7 position-relative z-index-2">
                    ...
                    if ($stmt->rowCount() > 0) {
                        ...
                        <table border="1">
                            ...
                            <tr>
                                <th class="example"><strong>Working Days</strong></th>
                                <td>
                            ...
                            <tr>
                                <th class="example"><strong>Consulting From</strong></th>
                                <td>
                                    <?php echo $row["working_from"]; ?>
                                </td>
                            </tr>

                            <tr>
                                <th class="example"><strong>Working T
                                        ill</strong></th>
                                <td>
                                    <?php echo $row["working_till"]; ?>
                                </td>
                            </tr>
                            ...
                            <?php if ($_SESSION['role'] !== 'doctor') { ?>
                                ...
                                <tr>
                                    ...
                                    <td>
                                        <?php
                                        $imageData_profile = $row['license_photo'];
                                        echo '<img src="data:image/jpeg;base64,' . base64_encode($imageData_profile) . '" alt="Profile Photo" />';
                                        ?>
                                    </td>
                                </tr>
