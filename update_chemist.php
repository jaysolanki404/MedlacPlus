...
if (isset($_POST['new']) && $_POST['new'] == 1) {
    ...
    $update = "UPDATE chemist SET profile_photo = :profile_photo, first_name = :first_name, last_name = :last_name, age = :age, phone = :phone, state = :state, city = :city, address = :address, license_number = :license_number, aadhar_number = :aadhar_number, email = :email WHERE id = :id ";
    ...
    if ($result) {
        ...
        echo '<script>window.location.href = "view_chemist_profile.php?id=' . $id . '";</script>';
    } else {
