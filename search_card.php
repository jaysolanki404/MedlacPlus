            ...
            <div class="row" style="display:inline;">
                <div class="col-lg-7 position-relative z-index-2">
                    ...
                    <div class="row justify-content-center">
                        <div class="col-md-8">
                            <div class="card">
                                <div class="card-header" style="background-color:#46a0f0fe; color:white;"><b> Enter
                                        Card Details</b>
                                </div>
                                <div class="card-body">
                                    <form method="POST" id="prescription" action="view_card.php"
