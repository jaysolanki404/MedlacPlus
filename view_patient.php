        ...
        <div class="button-group">
            ...
            <?php if ($_SESSION['role'] == 'doctor') { ?>
                <button class="btn btn-primary" style="display:inline; margin-right: 10px;"><i
                        class="fa-solid fa-plus fa-xl"></i> <a href="search_prescription.php" style="color:white">view
                        prescription</a></button>
            <?php } else { ?>
                <button class="btn btn-primary" style="display:inline; margin-right: 10px;"><i
                        class="fa-solid fa-plus fa-xl"></i> <a href="form_patient.php" style="color:white">Add
                        patient</a></button>
                <!---export--->
            <form method="POST" style="display:inline">
                <button type="submit" name="export_patient" class="btn btn-primary"><i
