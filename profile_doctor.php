                ...
                <div class="p-3 py-5">
                    ...
                    <div class="row mt-3">
                        ...
                        <div class="col-md-12"><label class="labels">Phone</label><input type="text"
                                class="form-control" value="<?php echo $row['phone']; ?>" readonly></div>
                        <br><br>
                        ...
                        <div class="row mt-3">
                            ...
                            <div class="col-md-6"><label class="labels">City</label><input type="text"
                                    class="form-control" value="<?php echo $row['city']; ?>" readonly></div>
                        </div><br><br><br><br>
                        <div class="col-md-12"><label class="labels">Address</label><input type="text"
                                class="form-control" value="<?php echo $row['address']; ?>" readonly></div>
                        <br><br><br>
                        <div class="col-md-12"><label class="labels">Hospital</label><input type="text"
                                class="form-control" value="<?php echo $row['hospital']; ?>" readonly></div><br><br><br>
                        <div class="col-md-12"><label class="labels">Qualifiaction</label><input type="text"
                                class="form-control" value="<?php echo $row['qualification']; ?>" readonly></div>
                        <br><br><br>
                        <div class="col-md-12"><label class="labels">Specialist</label><input type="text"
                                class="form-control" value="<?php echo $row['specialist']; ?>" readonly></div>

                        <br><br><br>
                        <div class="col-md-12"><label class="labels">Working Days</label><input type="text"
                                class="form-control" value="<?php echo $row['working_days']; ?>" readonly></div>

                        <br><br><br>
                        <div class="col-md-12"><label class="labels">Working From</label><input type="text"
                                class="form-control" value="<?php echo $row['working_from']; ?>" readonly></div>

                        <br><br><br>
                        <div class="col-md-12"><label class="labels">Working Till</label><input type="text"
                                class="form-control" value="<?php echo $row['working_till']; ?>" readonly></div>

                        <br><br><br>
                        <div class="col-md-12"><label class="labels">License No.</label><input type="text"
                                class="form-control" value="<?php echo $row['license_number']; ?>" readonly></div>
                        <br><br><br>
                    ...
                    <div class="row">
                        <div class="col-md-6">
                            <label class="labels">License Photo</label>
                            <?php
                            // Display the image using the appropriate content type
                            $imageData = $row['license_photo'];
                            echo '<img src="data:image/jpeg;base64,' . base64_encode($imageData) . '" alt="License Photo" style="width: 150px; height: 150px;" class="form-control"/>';
                            ?>
                        </div>

                        <div class="col-md-6">
                            <label class="labels">Digital Signature</label>
                            <?php
                            // Display the image using the appropriate content type
                            $imageData = $row['digital_signature'];
                            echo '<img src="data:image/jpeg;base64,' . base64_encode($imageData) . '" alt="Digital Signature" style="width: 150px; height: 150px;" class="form-control"/>';
                            ?>
                        </div>
                    </div>
                </div>
