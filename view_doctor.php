...
if (isset($_POST['export_doctor'])) {
    ...
    foreach ($data as $data_item) {
        ...
        fputcsv($output, [
            ...
            $data_item['city'],
            $data_item['address'],
            $data_item['qualification'],
            $data_item['working_days'],
            $data_item['working_from'],
            $data_item['working_till'],
            $data_item['hospital'],
...
<body class="g-sidenav-show  bg-gray-100">
    ...
    <main class="main-content">
        ...
        <div class="button-group">
            <button class="btn btn-primary" style="background-color: #216ABE; display:inline; margin-right: 10px;"><i
                    class="fa-solid fa-plus fa-xl"></i> <a href="form_doctor.php" style="color:white">Add
                    Doctor</a></button>
            <!---export--->
            <form method="POST" style="display:inline">
                <button type="submit" style="background-color: #216ABE;" name="export_doctor" class="btn btn-primary"><i
