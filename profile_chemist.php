                    ...
                    <div id="page-wrapper">
                        ...
                        if ($stmt->rowCount() > 0) {
                            ...
                            <table border="1">
                                ...
                                <tr>
                                    <th class="example"><strong>License No.</strong></th>
                                    <td>
                                ...
                                <tr>
                                    <th class="example"><strong>Authorized Signature Photo</strong></th>
                                    <td>
                                        <?php
                                        $imageData_sign = $row['digital_signature'];
                                        echo '<img src="data:image/jpeg;base64,' . base64_encode($imageData_sign) . '" alt="digital_signature Photo" />';
                                        ?>
                                    </td>
                                </tr>
