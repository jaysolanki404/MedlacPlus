...
if ($_SERVER["REQUEST_METHOD"] === "POST") {
    ...
    if (password_verify($current_password, $password)) {
        if ($new_password === $confirm_password) {
            ...
            $update = "UPDATE chemist SET password = :password WHERE id = :id ";
            ...
            if ($query->execute()) {
                ...
                header("location: profile_chemist.php");
                exit();
            } else {
                ...
                <div class="p-3 py-5">
                    ...
                    <div class="row mt-3">
                        <div class="col-md-12"><label class="labels">Age</label><input type="text" class="form-control"
                                value="<?php echo $row['age']; ?>" readonly></div><br><br><br>
                        <div class="col-md-12"><label class="labels">Phone No.</label><input type="text"
                    ...
                    <div class="col-md-12"><label class="labels">Address</label><input type="text" class="form-control"
                            value="<?php echo $row['address']; ?>" readonly></div><br>
                ...
                <div class="p-3 py-5">
                    <form action="" method="post">
                        <div class="d-flex justify-content-between align-items-center experience"><span>Change
                                PAssword</span><span class="border px-3 p-1 add-experience" onclick="history.back()"><i
