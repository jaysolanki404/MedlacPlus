...
<body class="g-sidenav-show  bg-gray-100">
                        ...
                        <div class="col-md-8">
                            ...
                            <div class="card">
                                <div class="card-header" style="background-color:#46a0f0fe; color:white;">Add
                                    Receptionist</div>
                                <div class="card-body">
                                    <form method="POST" id="receptionist" action="add_receptionist.php"
                                        ...
                                        <!-- pass -->
                                        <div class="form-group row">
                                            <label for="pass" class="col-md-4 col-form-label text-md-right">URN
                                                Series</label>
                                            <div class="col-md-6">
                                                <input type="number" id="pass" class="form-control" name="pass">
                                            </div>
                                        </div>
                                        ...
                                        <!-- <div class="form-group row">
                                            ...
                                            <div class="col-md-6">
                                                <input type="passsword" id="password" class="form-control"
                                                    name="password">
                                            </div>
                                        </div> -->
    ...
    <script src="assets/js/receptionist_validation.js"></script>
